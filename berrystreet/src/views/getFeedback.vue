...
<div class="feedback">
    ...
    <el-dialog
        ...
        style="font-family: 'Acme', sans-serif; text-align: center; font-size: 25px;"
        width="40%">
        <div style="margin-top:10px;width: 400px; height: 500px; margin: 10px auto; border-radius: 15px; background-color: #50A7C2;">
    ...
    <el-dialog
        ...
        style="font-family: 'Acme', sans-serif; text-align: center; font-size: 25px;"
        width="40%">
        <div style="margin-top:10px; width: 400px; height: 400px; margin: 10px auto; border-radius: 15px; background-color: #50A7C2;">
